                  ...
                  <div class="col-md-3">
                      <div>
                        ...
                        <a href="../php/phppage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> PHP</a>
                         <a href="pythonpage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Python</a>
                  ...
                  <div class="col-md-9">  
                      <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">PYTHON SYNTAXES</h3>
                        </div><br>
                            ...
                            <table class="table table-striped table-hover">
                              <tbody id ="mysearch">
                                ...
                                <?php
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM pythontbl ORDER BY python_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                    
                                    $sql = "SELECT * FROM pythontbl ORDER BY python_name ASC LIMIT $offset, $no_of_records_per_page";
                                    $qry = mysqli_query($conn,$sql);
                                    while($row = mysqli_fetch_array($qry)){
                                          $id = $row['python_id'];
                                        print '
                                            <tr>
                                            <td><a  href="pythonview.php?id='.$id.'"><button class="btn btn-sm btn-info" style = color:black;>'.$row['python_name'].'</button></a><td>
                                            <td>'.$row['python_description'].';</td>
                                            </tr>
                                            ';
                                    }
                                ?>
