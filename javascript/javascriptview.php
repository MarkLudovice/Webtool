<?php
  session_start();
    ...
    if(isset($_GET['id'])){
        $javascriptid = $_GET['id'];
    }

    $stmt11 = "SELECT * FROM javascriptbl WHERE javascript_id = '$javascriptid'";
    $result11 = mysqli_query($conn, $stmt11);
    while($row10 = mysqli_fetch_array($result11)){
        $javascriptname = $row10['javascript_name'];
        $javascriptcontent = $row10['javascript_content'];
        $javascriptdescription = $row10['javascript_description'];
