              ...
              <div class="row">
                  <div class="col-md-3">
                      <div>
                        ...
                        <a href="javascriptpage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Javascript</a>
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">JAVASCRIPT SYNTAXES</h3>
                        </div><br>
                              ...
                              <tbody id ="mysearch">
                                ...
                                <?php
                                   if (isset($_GET['pageno'])) {
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM javascriptbl ORDER BY javascript_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                    $sql = "SELECT * FROM javascriptbl ORDER BY javascript_name ASC LIMIT $offset, $no_of_records_per_page";
                                    $qry = mysqli_query($conn,$sql);
                                    while($row = mysqli_fetch_array($qry)){
                                          $id = $row['javascript_id'];
                                        print '
                                            <tr>
                                            <td><a  href="javascriptview.php?id='.$id.'"><button class="btn btn-sm btn-info" style = color:black;>'.$row['javascript_name'].'</button></a><td>
                                            <td> '.$row['javascript_description'].';</td>
                                            </tr>
                                            ';
