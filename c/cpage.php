                            ...
                            <table class="table table-striped table-hover">
                              <tbody id ="mysearch">
                                ...
                                <?php
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM ctbl ORDER BY c_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                   
                                    $sql = "SELECT * FROM ctbl ORDER BY c_name ASC LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    while($row = mysqli_fetch_array($qry)){
                                        ...
                                        print '
                                            ...
                                            <td><a  href="cview.php?id='.$id.'"><button class="btn btn-sm btn-info" style ="color:black;">'.$row['c_name'].'</button></a><td>
