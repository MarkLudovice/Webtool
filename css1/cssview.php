<?php
  session_start();
    ...
    $stmt11 = "SELECT * FROM css1_tbl WHERE css1_id = '$css1id'";
    $result11 = mysqli_query($conn, $stmt11);
    while($row10 = mysqli_fetch_array($result11)){
        $css1name = $row10['css1_name'];
        $css1content = $row10['css1_content'];
        $css1description = $row10['css1_description'];
      }
?>
                   ...
                   <div class="col-md-9">
                      <div class="panel panel-default">
                        ...
                        <?php
                          ...
                          echo '<h3 class="panel-title"> CSS Code Name</h3><pre>'.htmlspecialchars($code).'</pre>'; 
                        ?>
                        </div><br>
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title"> Description:<?php print $css1description?></h3>
                        </div>
