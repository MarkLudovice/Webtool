<?php
  session_start();
    ...
    $stmt11 = "SELECT * FROM pascaltbl WHERE pascal_id = '$pascalid'";
    $result11 = mysqli_query($conn, $stmt11);
    while($row10 = mysqli_fetch_array($result11)){
        $pascalname = $row10['pascal_name'];
        $pascalcontent = $row10['pascal_content'];
        $pascaldescription = $row10['pascal_description'];
