              ...
              <div class="row">
                  <div class="col-md-3">
                      <div>
                        ...
                        <a href="pascalpage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Pascal</a>
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">PASCAL SYNTAXES</h3>
                        </div><br>
                            ...
                            <table class="table table-striped table-hover">
                              <tbody id ="mysearch">
                                ...
                                <?php
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM pascaltbl ORDER BY pascal_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                   
                                    $sql = "SELECT * FROM pascaltbl ORDER BY pascal_name ASC LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    while($row = mysqli_fetch_array($qry)){
                                        ...
                                        print '
                                            ...
                                            <td><a  href="pascalview.php?id='.$id.'"><button class="btn btn-sm btn-info" style ="color:black;">'.$row['pascal_name'].'</button></a><td>
                                            <td> '.$row['pascal_description'].'</td>
                                            </tr>
                                            ';
                                    }
                                ?>
