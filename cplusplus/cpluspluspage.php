              ...
              <div class="row">
                  <div class="col-md-3">
                      <div>
                        ...
                        <a href="cpluspluspage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> C++</a>
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">C++ SYNTAXES</h3>
                        </div><br>
                            ...
                            <table class="table table-striped table-hover">
                              <tbody id ="mysearch">
                                ...
                                <?php
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM cplustbl ORDER BY cplus_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                   
                                    $sql = "SELECT * FROM cplustbl ORDER BY cplus_name ASC LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    while($row = mysqli_fetch_array($qry)){
                                        ...
                                        print '
                                            ...
                                            <td><a  href="cplusview.php?id='.$id.'"><button class="btn btn-sm btn-info" style ="color:black;">'.$row['cplus_name'].'</button></a><td>
                                            <td> '.$row['cplus_description'].'</td>
                                            </tr>
                                            ';
                                    }
                                ?>
