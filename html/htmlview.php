<?php
  session_start();
    ...
    $stmt11 = "SELECT * FROM htmltbl WHERE html_id = '$htmlid'";
    $result11 = mysqli_query($conn, $stmt11);
    while($row10 = mysqli_fetch_array($result11)){
        $htmlname = $row10['html_name'];
        $htmlcontent = $row10['html_content'];
        $htmldescription = $row10['html_description'];
      }
?>
                   ...
                   <div class="col-md-9">
                      <div class="panel panel-default">
                        ...
                        <?php
                          ...
                          echo '<h3 class="panel-title"> HTML Code Name</h3><pre>'.htmlspecialchars($code).'</pre>'; 
                        ?>
                        </div><br>
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title"> Description:<?php print $htmldescription?></h3>
                        </div>
