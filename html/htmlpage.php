              ...
              <div class="row">
                  <div class="col-md-3">
                      <div>
                        ...
                        <a href="htmlpage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> HTML</a>
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">HTML SYNTAXES</h3>
                        </div><br>
                            ...
                            <table class="table table-striped table-hover">
                              <tbody id ="mysearch">
                                ...
                                <?php
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM htmltbl ORDER BY html_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                   
                                    $sql = "SELECT * FROM htmltbl ORDER BY html_name ASC LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    while($row = mysqli_fetch_array($qry)){
                                        ...
                                        print '
                                            ...
                                            <td><a  href="htmlview.php?id='.$id.'"><button class="btn btn-sm btn-info" style ="color:black;">'.$row['html_name'].'</button></a><td>
