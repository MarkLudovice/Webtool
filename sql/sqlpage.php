              ...
              <div class="row">
                  <div class="col-md-3">
                      <div>
                        ...
                        <a href="sqlpage.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> SQL</a>
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">SQL SYNTAXES</h3>
                        </div><br>
                              ...
                              <tbody id = "mysearch">
                                ...
                                <?php
                                   ...
                                   if (isset($_GET['pageno'])) {
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM sql_tbl ORDER BY sql_name ASC";
                                    $result = mysqli_query($conn,$total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                    
                                    $sql = "SELECT * FROM sql_tbl ORDER BY sql_name ASC Limit $offset, $no_of_records_per_page";
                                    $qry = mysqli_query($conn,$sql);
                                    while($row = mysqli_fetch_array($qry)){
                                          $id = $row['sql_id'];
                                        print '
                                            <tr>
                                            <td><a  href="sqlview.php?id='.$id.'"><button class="btn btn-sm btn-info" style = color:black;>'.$row['sql_name'].'</button></a><td>
